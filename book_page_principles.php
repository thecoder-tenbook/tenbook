...
<head>
    ...
    <title>Принципи — короткий зміст і ключові ідеї | TENBOOK</title>
    <meta name="description" content="Короткий зміст «Принципів» Рея Даліо: 8 ключових ідей за 18 хвилин. Система прийняття рішень засновника найбільшого хедж-фонду світу — Bridgewater.">
    <link rel="canonical" href="https://tenbook.com.ua/book_page_principles">

    <!-- Open Graph -->
    <meta property="og:type" content="book">
    <meta property="og:title" content="Принципи — короткий зміст | TENBOOK">
    <meta property="og:description" content="Короткий зміст «Принципів» Рея Даліо: 8 ключових ідей за 18 хвилин. Система прийняття рішень засновника Bridgewater — найбільшого хедж-фонду світу.">
    <meta property="og:url" content="https://tenbook.com.ua/book_page_principles">
    <meta property="og:site_name" content="TENBOOK">
    <meta property="og:image" content="https://tenbook.com.ua/covers_ua/Principles.svg">
    <meta property="og:locale" content="uk_UA">
    <meta property="book:author" content="Рей Даліо">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Принципи — короткий зміст | TENBOOK">
    <meta name="twitter:description" content="8 ключових ідей за 18 хвилин. Як Рей Даліо побудував Bridgewater і систему прийняття рішень, що змінила менеджмент.">
    <meta name="twitter:image" content="https://tenbook.com.ua/covers_ua/Principles.svg">
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "Book",
          "@id": "https://tenbook.com.ua/book_page_principles#book",
          "name": "Принципи. Життя і робота",
          "alternateName": "Principles: Life and Work",
          "author": {
            "@type": "Person",
            "name": "Рей Даліо",
            "alternateName": "Ray Dalio"
          },
          "inLanguage": "uk",
          "description": "«Принципи» — це спроба систематизувати п'ять десятиліть помилок і перемог Рея Даліо в набір алгоритмів для прийняття рішень.",
          "genre": "Бізнес, менеджмент, саморозвиток",
          "numberOfPages": 592,
          "aggregateRating": {
        ...
        {
          "@type": "Article",
          "@id": "https://tenbook.com.ua/book_page_principles#article",
          "headline": "Принципи — короткий зміст і ключові ідеї",
          "description": "Короткий зміст книги «Принципи» Рея Даліо: 8 ключових ідей за 18 хвилин читання.",
          "about": { "@id": "https://tenbook.com.ua/book_page_principles#book" },
          "inLanguage": "uk",
          "publisher": {
            "@type": "Organization",
            "name": "TENBOOK",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Принципи" }
          ]
        }
      ]
    }
...
<div class="page-cover-col">
    <div class="hero-cover" style="background:#1B2E50;position:relative;overflow:hidden;">
    ...
    <div class="hero-cover-actions">
        <a class="btn-read" href="reader_principles">
...
<div class="breadcrumb">
    ...
    <a href="catalog_page">Бізнес</a>
    <span class="breadcrumb-sep">›</span>
    <span class="breadcrumb-current">Принципи</span>
</div>

    <!-- Info -->
    <div class="hero-info">
        <div class="hero-category">Бізнес · Менеджмент · Лідерство</div>
        <h1 class="hero-title">Принципи</h1>
        <p class="hero-author">Автор: <a href="#">Рей Даліо</a></p>
        ...
        <p class="hero-desc">
            Даліо зібрав принципи, що дозволили йому керувати найбільшим хедж-фондом у світі — і зробив їх доступними для кожного.
        </p>
        ...
        <div class="hero-leaders-row">
            ...
            <div class="leader-avatar" style="margin-left:-8px;">
                <img src="https://unavatar.io/twitter/tobi" alt="Тобіас Лютке">
            </div>
            <div class="leader-avatar" style="margin-left:-8px;">
                <img src="https://unavatar.io/twitter/naval" alt="Навал Равікант">
            </div>
            <span class="hero-leaders-text">Білл Гейтс, Навал Равікант та ще 14 лідерів</span>
        </div>
    </div>
...
<div class="tabs-wrapper">
    <div class="tabs-inner">
        ...
        <button class="tab-btn" onclick="switchTab('reviews', this)">Відгуки <span class="tab-count">31</span></button>
    </div>
</div>
...
<div class="content-wrapper">
    <div class="main-col">
        ...
        <div class="tab-panel active" id="panel-ideas">
            ...
            <div class="ideas-list">
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">1</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Радикальна відкритість і правдивість</h3>
                        <div class="idea-text">Даліо управляв найбільшим хедж-фондом світу. Але головним інструментом були не алгоритми — а список принципів, який він вів десятки років. Як це працює?</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">2</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Принципи як алгоритми рішень</h3>
                        <div class="idea-text">Більшість керівників уникають незручної правди. Даліо зробив її обов'язковою умовою роботи в Bridgewater. Що з цього вийшло?</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">3</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Компанія як машина</h3>
                        <div class="idea-text">Що якщо кожне рішення в компанії можна звести до алгоритму? Даліо спробував — і це змінило все.</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">4</div>
                    <div class="idea-content">
                        <h3 class="idea-title">П'ятирівневий процес досягнення мети</h3>
                        <div class="idea-text">Bridgewater записує абсолютно всі наради. Жодних таємних розмов, жодної прихованої agenda. Чому це геніально — і чому більшість компаній ніколи на таке не зважаться?</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">5</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Радикальна прозорість</h3>
                        <div class="idea-text">У Bridgewater голос стажера може переважити думку топ-менеджера. Але тільки за однієї умови.</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">6</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Зважені рішення за заслугами</h3>
                        <div class="idea-text">Даліо каже: болісна помилка + рефлексія = прогрес. Він вивів формулу, яка перетворює невдачі на найцінніший актив.</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">7</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Біль як інструмент зростання</h3>
                        <div class="idea-text">Більшість людей думають про свою компанію як про команду. Даліо думає про неї як про машину — і пояснює, чому це радикально змінює підхід до управління.</div>
                    </div>
                </div>
                <div class="idea-card" onclick="window.location='reader_principles'">
                    <div class="idea-num">8</div>
                    <div class="idea-content">
                        <h3 class="idea-title">Архітектор власного життя</h3>
                        <div class="idea-text">Як людина, яка в 26 почала з нуля, стала менеджером $160 млрд? Даліо каже: справа не в таланті. А в чому — читайте всередині.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="quote-block">
                ...
                <p class="quote-text">Найцінніше в людини — не те, що вона знає, а те, як вона реагує на те, чого не знає.</p>
                <p class="quote-source">— Рей Даліо, Принципи</p>
            </div>
        </div>
        ...
        <div class="tab-panel" id="panel-about">
            ...
            <div class="about-text">
                <p>«Принципи. Життя і робота» — це не черговий бізнес-посібник. Це п'ятдесят років кристалізованого досвіду однієї людини, яка побудувала найбільший у світі хедж-фонд, пройшовши через катастрофічні помилки і навчившись із них більше, ніж із перемог.</p>
                <p>Рей Даліо засновник Bridgewater Associates — компанії, що управляє активами понад 160 мільярдів доларів. Але книга — не про фінансові ринки. Вона про систему мислення, яку Даліо назвав «меритократією ідей»: культуру, де правда важливіша за комфорт, де вага голосу залежить від компетентності, а не від посади, і де кожна помилка — не привід для сорому, а сировина для принципу.</p>
                <p>Книга структурована у три частини: особиста історія Даліо (від Queens до Bridgewater), принципи для особистого життя і принципи для організацій. Найчитабельніша і найпровокативніша частина — організаційні принципи, що описують культуру Bridgewater: радикальну прозорість, записані наради, публічні профілі слабких сторін співробітників і систему зваженого голосування.</p>
                <p>Книга продана понад 3 мільйони копій у 30 країнах. Вона є обов'язковим читанням у провідних бізнес-школах і інвестиційних компаніях. Forbes, Fortune і Business Insider включають її до найвпливовіших бізнес-книг XXI століття.</p>
            </div>
        </div>
        ...
        <div class="tab-panel" id="panel-author">
            ...
            <h2 class="section-heading">Рей Даліо</h2>
            <p class="section-sub">Інвестор, підприємець, філантроп</p>
            <div class="about-text">
                <p>Рей Даліо народився у 1949 році в Квінсі, Нью-Йорк, у сім'ї джазового музиканта. У дванадцять років він купив перші акції, підробляючи ношенням ціпків на полі для гольфу. У 1975 році, у 26 років, він заснував Bridgewater Associates з двокімнатної квартири на Манхеттені — з телефоном і мінімальним капіталом.</p>
                <p>Криза 1982 року ледве не знищила компанію: Даліо публічно передбачив глобальну рецесію, ринки пішли вгору, і він майже втратив все. Цей момент — найболіснішій і найважливіший у його кар'єрі — став фундаментом системи принципів, що описана в книзі. Bridgewater відродився і перетворився на найбільший хедж-фонд у світі.</p>
                <p>Даліо правильно передбачив фінансову кризу 2008 року і заробив для своїх клієнтів мільярди, тоді як більшість великих банків зазнавали катастрофічних збитків. Його «Машина економіки» — YouTube-відео, що пояснює економічні цикли — переглянули понад 40 мільйонів разів.</p>
                <p>Він підписав «Клятву дарування» Білла Гейтса і Уоррена Баффета — зобов'язання передати більшість статків на благодійність. Він практикує Трансцендентальну Медитацію двічі на день протягом понад п'ятдесяти років і стверджує, що саме медитація — основа його психологічної рівноваги і ясності мислення.</p>
            </div>
        ...
        <div class="tab-panel" id="panel-reviews">
            ...
            <p class="section-sub">31 відгук · середня оцінка 4.7 із 5</p>
            ...
            <div class="reviews-summary">
                <div class="reviews-big-score">
                    ...
                    <div class="reviews-total">31 відгук</div>
                </div>
    ...
    <aside class="sidebar">
        <div class="sidebar-card">
            ...
            <div class="progress-ring-wrap">
                ...
                <div>
                    ...
                    <div class="progress-info-sub">Залишилось ~16 хв</div>
                </div>
            </div>
            <button class="continue-btn" onclick="window.location='reader_principles'">Читати зараз</button>
        </div>

        <div class="sidebar-card">
            <div class="sidebar-card-title">Схожі книги</div>
            <a class="related-book" href="book_page_zero_to_one">
            ...
            <a class="related-book" href="book_page_7habits">
            ...
            <a class="related-book" href="book_page_sapiens">
                <div class="related-cover" style="background:#F6F1E8;position:relative;overflow:hidden;">
                    <img src="covers_ua/Sapiens.svg" style="position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;display:block;">
                </div>
                <div>
                    <div class="related-title">Сапієнс</div>
                    <div class="related-author">Юваль Ной Харарі</div>
                    <div class="related-rating">
                        <svg width="10" height="10" viewBox="0 0 24 24" fill="#fbbf24"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/></svg>
                        4.7
                    </div>
        ...
        <div class="sidebar-card">
            ...
            <div class="tags-row">
                <span class="tag">Менеджмент</span>
                <span class="tag">Лідерство</span>
                <span class="tag">Рішення</span>
                <span class="tag">Корпоративна культура</span>
                <span class="tag">Інвестиції</span>
