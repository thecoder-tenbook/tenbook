    ...
    <script>
        ...
        function renderBooks() {
            ...
            grid.innerHTML = filteredBooks.map(book => `
                <div class="book-card" ${book.title === 'Атомні Звички' ? "onclick=\"window.location='book_page_atomic_habits'\"" : book.title === '7 Звичок' ? "onclick=\"window.location='book_page_7habits'\"" : book.title === 'Від Нуля до Одиниці' ? "onclick=\"window.location='book_page_zero_to_one'\"" : book.title === 'Сапієнс' ? "onclick=\"window.location='book_page_sapiens'\"" : book.title === 'Принципи' ? "onclick=\"window.location='book_page_principles'\"" : book.title === 'Від Хорошого до Величного' ? "onclick=\"window.location='book_page_good_to_great'\"" : ''} style="${book.title === 'Атомні Звички' || book.title === '7 Звичок' || book.title === 'Від Нуля до Одиниці' || book.title === 'Сапієнс' || book.title === 'Принципи' || book.title === 'Від Хорошого до Величного' ? 'cursor:pointer;' : ''}">
                    <div class="book-cover" style="background: ${book.title === 'Сапієнс' ? '#F6F1E8' : book.title === 'Принципи' ? '#EDEEE9' : book.title === 'Від Хорошого до Величного' ? '#F0EDE8' : book.title === 'Від Нуля до Одиниці' ? '#E4EBF5' : book.title === 'Атомні Звички' ? '#EBF8EF' : book.gradient};">
